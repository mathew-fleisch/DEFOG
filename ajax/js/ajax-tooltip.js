...
function ajax_showTooltip(e,externalFile,inputObj)
{
   ...
   if(document.all)e = event;
	...
	if(!ajax_tooltipObj)	/* Tooltip div not created yet ? */
	{
		...
		buttonDiv.style.cssText = 'position:absolute;left:21px;top:2px;text-align:center;background-color:#fff;font-size:0.8em;height:15px;z-index:10000000';
...
function ajax_positionTooltip(e,inputObj)
{
	...
	if(inputObj){
		var leftPos = (ajaxTooltip_getLeftPos(inputObj) + 30);// + inputObj.offsetWidth);
   ...
   ajax_tooltipObj.style.left = tempX + 'px';
   ajax_tooltipObj.style.top = tempY + 'px';   
} 
